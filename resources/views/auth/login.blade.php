@extends('layouts.app', ['class' => 'off-canvas-sidebar', 'activePage' => 'login', 'title' => __('E-Filling')])
        ...
        <div class="card card-login card-hidden mb-3">
          ...
          <div class="card-body">
              <div class="bmd-form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                    <p class="card-description text-center">{{ __('Login for admin or superadmin ! ') }}</p>
